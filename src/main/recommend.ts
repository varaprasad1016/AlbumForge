/** AI design recommendation — local, deterministic, no models and no network.

Palette analysis (k-means over a downscaled preview) plus event-type rules produce a
page-level suggestion: background colour, pattern, an ornament graphic, and a font
pairing. Kept pure where possible so the rules can be unit-tested.
*/
import sharp from "sharp";
import { findGraphic, GRAPHICS } from "../shared/designs";
import { PAGE_PATTERNS } from "../shared/patterns";
