...
export const TEMPLATE_FAMILIES: Array<{
  ...
  { name: "Zen Nature", key: "zen_nature", description: "Calm organic layouts with breathing room.", style: { margin: 0.045, gutter: 0.04, safeArea: 0.06, chronological: true, background: "#f2f7f0" }, layouts: [["full_bleed", 0.8], ["hero_left", 0.9], ["hero_right", 0.9], ["two_vertical", 0.9], ["centerpiece", 1.0], ["three_grid", 0.7], ["four_grid", 0.6], ["spread_hero", 0.6]] },
  { name: "Party Mode", key: "party", description: "Festive, colorful collages for celebrations.", style: { margin: 0.02, gutter: 0.02, safeArea: 0.04, chronological: false, background: "#fff1f5" }, layouts: [["four_grid", 1.0], ["six_collage", 1.2], ["eight_collage", 1.1], ["nine_collage", 0.9], ["five_asymmetric", 0.9], ["full_bleed", 0.6], ["spread_grid_four", 0.8], ["spread_triptych", 0.6]] },
  { name: "Love Letters", key: "love_letters", description: "Soft, romantic layouts for weddings.", style: { margin: 0.035, gutter: 0.035, safeArea: 0.055, chronological: true, background: "#fdf0f0" }, layouts: [["full_bleed", 0.8], ["hero_left", 1.0], ["hero_right", 1.0], ["two_vertical", 0.8], ["centerpiece", 0.9], ["three_grid", 0.7], ["four_grid", 0.6], ["spread_hero", 0.8], ["spread_triptych", 0.6]] },
];
